...
window.configQuickbar = {
    fonts: {
        eot: '/template/pc/{eyou:global name='web_templets_pc' /}/skin/fonts/iconfont.eot',
        woff: '/template/pc/{eyou:global name='web_templets_pc' /}/skin/fonts/iconfont.woff',
        ttf: '/template/pc/{eyou:global name='web_templets_pc' /}/skin/fonts/iconfont.ttf',
        svg: '/template/pc/{eyou:global name='web_templets_pc' /}/skin/fonts/iconfont.svg'
    }
};
// 初始化事件
// 返回顶部
