...
var _typeof = "function" == typeof Symbol && "symbol" == _typeof2(Symbol.iterator) ? function (t) {
  ...
  n.meyou = { init: function init() {
      ...
      }return meyou.css3_3d = function () {
        return n;
      }, n;
    }, lazyLoad: function lazyLoad(e, i) {
      return e.each(function (o) {
        var a = t(this);return void 0 === a.attr("data-src") && void 0 === i ? (meyou.lazyLoad(e.not(a)), !1) : (a.show = function () {
      ...
      var e, i, o, a, s, r, c;return i = "number" != typeof arguments[1] ? 150 : arguments[1], "object" == _typeof(arguments[0]) ? "box" == arguments[2] ? (o = a = arguments[0], s = e = t("a[href='#top']"), r = meyou.letter(function () {
        a.scrollTop() > i ? e.fadeIn() : e.fadeOut("fast");
      })) : (o = t("html,body"), a = t(n), s = arguments[0], e = s.find("a[href='#top']"), r = meyou.letter(function () {
      ...
      })) : (o = t("html,body"), a = t(n), s = e = t("a[href='#top']"), r = meyou.letter(function () {
        a.scrollTop() > i ? e.fadeIn() : e.fadeOut("fast");
      })), e.click(function () {
    ...
    i = arguments[1] ? arguments[1] : {};var o = function o(t, n) {
      ...
      function i() {
        s.width > 0 || s.height > 0 ? (o("imgAutoStart", s), a.css({ display: "block", margin: 0 }).parent().css("overflow", "hidden"), c = s.width, l = s.height, u = r.width(), d = r.height(), f = d / l * c, h = u / c * l, c / l < u / d ? p ? a.css({ width: "100%", height: "auto" }).css("margin-top", -(h - d) / 2) : a.css({ width: "auto", height: "100%" }).css("margin-left", (u - f) / 2) : p ? a.css({ width: "auto", height: "100%" }).css("margin-left", -(f - u) / 2) : a.css({ width: "100%", height: "auto" }).css("margin-top", (d - h) / 2)) : setTimeout(i), o("callback", s);
          ...
          m = a.attr("width"),
          v = a.attr("height");m && v ? ((r = t('<div class="imgAuto_box"></div>')).css({ width: m, height: v, "text-align": "left", overflow: "hidden" }), a.wrapAll(r)) : r = a.parent(), i(), a.fadeTo(2e3, 1);var g = meyou.letter(i);t(n).resize(g);
    }), this;
  };
}(jQuery, window, document), meyou.rem(320), $(window).resize(function () {
  meyou.rem(320);
});
