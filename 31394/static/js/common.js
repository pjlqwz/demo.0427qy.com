...
/* -------------- index --------------*/
var galleryThumbs = new Swiper('.promote_thumbs', {
    spaceBetween: 10
    , slidesPerView: 10
    , loop: false
    , freeMode: true
...
var galleryTop = new Swiper('.promote_slider', {
    spaceBetween: 0
    , speed: 600
    , lazy: true
    , autoplay: {
...
var rcmdSwiper = new Swiper('.index_product_rcmd .product_slider', {
    slidesPerView: 6
    , slidesPerGroup: 6
    , speed: 600
    , spaceBetween: 16
    ...
    , pagination: {
        el: '.index_product_rcmd .swiper-pagination'
        , clickable: true
    , }
    , navigation: {
        nextEl: '.index_product_rcmd .swiper-button-next'
        , prevEl: '.index_product_rcmd .swiper-button-prev'
    , }
    , breakpoints: {
        1280: {
            slidesPerView: 5
...
// side_quicks
$(function () {
    var $sideQuick = $('#side_quicks');
    $sideQuick.find('.quick_toggle')
        .on('click', function () {
            if (!$sideQuick.hasClass('active')) {
