...
var featuredSwiper=new Swiper('.featured_slider',{slidesPerView:4,slidesPerGroup:4,speed:400,loop:false,spaceBetween:70,initialSlide:0,pagination:{el:'.index_featured .swiper-pagination',clickable:true,},navigation:{nextEl:'.index_featured .swiper-button-next',prevEl:'.index_featured .swiper-button-prev',},breakpoints:{1440:{spaceBetween:30},1280:{spaceBetween:20},1024:{slidesPerView:3,slidesPerGroup:3,spaceBetween:10,centeredSlides:false},640:{slidesPerView:2,slidesPerGroup:2,spaceBetween:10,centeredSlides:false},480:{slidesPerView:1,slidesPerGroup:1,spaceBetween:10,centeredSlides:false}}});var pdSwiper=new Swiper('.product_slider',{slidesPerView:4,slidesPerGroup:4,speed:400,loop:true,spaceBetween:20,initialSlide:0,pagination:{el:'.index_product .swiper-pagination',clickable:true,},navigation:{nextEl:'.index_product .swiper-button-next',prevEl:'.index_product .swiper-button-prev',},breakpoints:{1440:{},1280:{},1024:{slidesPerView:3,slidesPerGroup:3,spaceBetween:10,centeredSlides:false},640:{slidesPerView:2,slidesPerGroup:2,spaceBetween:10,centeredSlides:false},480:{slidesPerView:1,slidesPerGroup:1,spaceBetween:10,centeredSlides:false}}});function changImg(sourceEle,imgEle){$(sourceEle).hover(function(){var imgSrc=$(this).attr('data-newsImg');$(imgEle).attr('src',imgSrc)})}
$(function(){changImg('.index_news .news_item','.index_news .news_img img')})
var sideProduct=new Swiper('.side_slider',{slidesPerView:5,slidesPerGroup:1,spaceBetween:0,direction:'vertical',navigation:{nextEl:'.side-product-items .btn-next',prevEl:'.side-product-items .btn-prev',},pagination:{el:'.side-product-items .swiper-pagination',clickable:true,},});var mSwiper=new Swiper('.main_banner_slider',{effect:'fade',speed:1000,loop:true,spaceBetween:0,autoplay:{delay:3500,disableOnInteraction:false,},pagination:{el:'.main_banner_slider .swiper-pagination',clickable:true,}});$(function(){$(document).on('click',function(){$('.container').removeClass('main-wrap--move');$('.web-search').removeClass('search--open');})
