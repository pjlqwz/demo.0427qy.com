...
var navWidth=function(){
	...
	if($('.w-logo-img').is(':visible')){
		...
		img.onload = function () {
			...
			$('.body-login .w-admin-nav').css({'max-width':outWid-logoWid-shopCartWid-52,'margin-left':logoWid+50});
			$('.body-admin .w-admin-nav').css({'max-width':outWid-logoWid-shopCartWid-52,'margin-left':logoWid+50});
