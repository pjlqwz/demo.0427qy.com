...
var pdSwiper=new Swiper('.index_product .featured_slider',{slidesPerView:5,speed:400,spaceBetween:20,pagination:{el:'.index_product .swiper-pagination',clickable:true,},navigation:{nextEl:'.index_product .swiper-button-next',prevEl:'.index_product .swiper-button-prev',},breakpoints:{1200:{slidesPerView:4},950:{slidesPerView:3,spaceBetween:16},640:{slidesPerView:2,spaceBetween:10},480:{slidesPerView:2,spaceBetween:10}}});$(function(){var $sideQuick=$('#side_quicks');$sideQuick.find('.quick_toggle').on('click',function(){if(!$sideQuick.hasClass('active')){$sideQuick.addClass('active');}
else{$sideQuick.removeClass('active');}})
var mouseover_tid=[];var mouseout_tid=[];$sideQuick.find('.quick_item').each(function(index){$(this).hover(function(){var _self=this;clearTimeout(mouseout_tid[index]);mouseover_tid[index]=setTimeout(function(){$(_self).addClass("hover");},100);},function(){var _self=this;clearTimeout(mouseover_tid[index]);mouseout_tid[index]=setTimeout(function(){$(_self).removeClass("hover");},50);});});})
