...
$('.product-btn-wrap .email,.company_subscribe .button,.side_content .side_list .inquiry').click(function(){$("html, body").animate({scrollTop:webTop},1000);$(".ad_prompt").show().delay(3000).hide(300);})}else{$('.product-btn-wrap .email,.company_subscribe .button,.side_content .side_list .inquiry').click(function(){$('.inquiry-pop-bd').fadeIn('fast')})}
$('.inquiry-pop,.product-btn-wrap .email,.company_subscribe .button,.side_content .side_list .inquiry').click(function(e){e.stopPropagation();})
...
var historySwiper=new Swiper('.news_slider',{effect:'fade',slidesPerView:1,slidesPerGroup:1,loop:true,speed:600,spaceBetween:0,pagination:{el:'.index_news .news_controls',clickable:true,bulletClass:'dot-bullet',bulletActiveClass:'active',clickable:true,renderBullet:function(index,className){return'<li data-wow-delay=".'+(index+1)+'s" class="control_dot wow fadeInLeftA dot_'+(index+1)+' '+className+'"><div class="dot_inner"><span class="dot_time"><em>news :</em>'+(index+1)+'</span><i class="dot_ico"></i></div></li>';},renderBullet:function(index,className){var slideEle=$('.news_slider').find('.swiper-slide').not('.swiper-slide-duplicate');var slideLen=slideEle.length;for(i=0;i<slideLen;i++){if(index==i){text=slideEle.eq(i).data('slidetxt');}}
return'<li data-wow-delay=".'+(index+1)+'s" class="control_dot wow fadeInLeftA dot_'+(index+1)+' '+className+'"><div class="dot_inner"><span class="dot_time"><em>news :</em>'+(index+1)+'</span><i class="dot_ico"></i></div></li>';}},navigation:{nextEl:'.index_news .swiper-button-next',prevEl:'.index_news .swiper-button-prev',},breakpoints:{}});var pdSwiper=new Swiper('.promote_slider',{slidesPerView:2,speed:400,loop:false,spaceBetween:35,initialSlide:0,pagination:{el:'.index_promote .swiper-pagination',clickable:true,},navigation:{nextEl:'.index_promote .swiper-button-next',prevEl:'.index_promote .swiper-button-prev',},breakpoints:{1440:{spaceBetween:30},1280:{spaceBetween:20},1024:{slidesPerView:2,spaceBetween:20,centeredSlides:false},480:{slidesPerView:1,spaceBetween:10,centeredSlides:false}}});var sideProduct=new Swiper('.side_slider',{slidesPerView:5,slidesPerGroup:1,spaceBetween:0,direction:'vertical',navigation:{nextEl:'.side-product-items .btn-next',prevEl:'.side-product-items .btn-prev',},pagination:{el:'.side-product-items .swiper-pagination',clickable:true,},});var mSwiper=new Swiper('.main_banner_slider',{effect:'fade',speed:1000,loop:true,spaceBetween:0,autoplay:{delay:3500,disableOnInteraction:false,},pagination:{el:'.main_banner_slider .swiper-pagination',clickable:true,}});$(function(){$(document).on('click',function(){$('.container').removeClass('main-wrap--move');$('.web-search').removeClass('search--open');})
